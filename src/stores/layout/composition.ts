 ...
 */
export interface ComposedLayoutStore extends 
  SidebarSlice, 
  PreferencesSlice, 
  NavigationSlice {
 ...
 */
export const createComposedLayoutStore = (): StateCreator<
  ComposedLayoutStore,
  [],
  [],
  ComposedLayoutStore
 ...
 */
export const selectLayoutActions = (state: ComposedLayoutStore): LayoutActions => ({
  // Sidebar actions
